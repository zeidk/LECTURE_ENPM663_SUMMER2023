...
\newtcbox{\myTerminal}{enhanced,nobeforeafter,tcbox raise base,boxrule=0.5pt,top=0mm,bottom=0mm,
  right=0mm,left=6mm,arc=1pt,boxsep=1pt, fontupper=\ttfamily, before upper={\vphantom{dlg}},
  colframe=BrickRed,coltext=white,colback=black,
  overlay={\begin{tcbclipinterior}\fill[white] (frame.south west)
    rectangle node[text=BrickRed,font=\sffamily\bfseries\tiny,rotate=0] {\faTerminal} ([xshift=6mm]frame.north west);\end{tcbclipinterior}}}
...
\emph{Passing arguments to a function.}
...
{\large \mycodesyntax Function Selection} \doublerulefill

\emph{You can give the user a choice of the function to execute when you open a terminal}
...
function select_function(){
  ...
  echo -n "Select a function: "
  read choice
  case $choice in
    1) one;;
    2) two;;
    *) echo "No function was selected";;
  esac
}
